...
import org.w3c.dom.svg.fonts.SVGHKernElement;
...
public class SVGHKernElementParser implements ElementParser<SVGHKernElement> {
	...
	@Override
	public Element writeElement(SVGHKernElement element, ElementFactory factory) {
		...
		return factory.createElement(Tags.HKERN, attributes);
	}
