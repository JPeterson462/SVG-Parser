...
public interface Attributes {
	...
	public static final String LIMITING_CONE_ANGLE = "limitingConeAngle";
	...
	public static final String UNDERLINE_THICKNESS = "underline-thickness";
	
	public static final String UNICODE = "unicode";
	
	public static final String UNICODE_RANGE = "unicode-range";
	
	public static final String UNITS_PER_EM = "units-per-em";

	public static final String VALUES = "values";

	public static final String V_ALPHABETIC = "v-alphabetic";
	...
	public static final String V_HANGING = "v-hanging";
	
	public static final String V_IDEOGRAPHIC = "v-ideographic";
	
	public static final String VIEW_BOX = "viewBox";
	
	public static final String VIEW_TARGET = "viewTarget";
	
	public static final String V_MATHEMATICAL = "v-mathematical";
