...
import org.w3c.dom.svg.filters.SVGFEFuncGElement;
...
public class SVGFEFuncGElementParser implements ElementParser<SVGFEFuncGElement> {
	...
	@Override
	public SVGFEFuncGElement readElement(Element element, ParsingState parsingState) {
		...
		return new SVGFEFuncGElement.Implementatation(id, xmlBase, ownerSVGElement, viewportElement,
				type, tableValues, slope, intercept, amplitude, exponent, offset);
	}

	@Override
	public Element writeElement(SVGFEFuncGElement element, ElementFactory factory) {
