...
import org.w3c.dom.svg.filters.SVGFETileElement;
...
public class SVGFETileElementParser implements ElementParser<SVGFETileElement> {

	@Override
	public SVGFETileElement readElement(Element element, ParsingState parsingState) {
	...
	@Override
	public Element writeElement(SVGFETileElement element, ElementFactory factory) {
		...
		return factory.createElement(Tags.FE_TILE, attributes);
	}
