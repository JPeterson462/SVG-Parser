...
public class SVGFEFuncRElementParser implements ElementParser<SVGFEFuncRElement> {
	...
	public SVGFEFuncRElement readElement(Element element, ParsingState parsingState) {
		...
		return new SVGFEFuncRElement.Implementatation(id, xmlBase, ownerSVGElement, viewportElement,
				type, tableValues, slope, intercept, amplitude, exponent, offset);
	}

	@Override
	public Element writeElement(SVGFEFuncRElement element, ElementFactory factory) {
