...
import org.w3c.dom.svg.filters.SVGFEOffsetElement;
...
public class SVGFEOffsetElementParser implements ElementParser<SVGFEOffsetElement> {
	...
	@Override
	public Element writeElement(SVGFEOffsetElement element, ElementFactory factory) {
		...
		return factory.createElement(Tags.FE_OFFSET, attributes);
	}
