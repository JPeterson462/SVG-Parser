...
import org.w3c.dom.svg.filters.SVGFEFuncAElement;
...
public class SVGFEFuncAElementParser implements ElementParser<SVGFEFuncAElement> {
	...
	@Override
	public SVGFEFuncAElement readElement(Element element, ParsingState parsingState) {
		...
		return new SVGFEFuncAElement.Implementatation(id, xmlBase, ownerSVGElement, viewportElement,
				type, tableValues, slope, intercept, amplitude, exponent, offset);
	}

	@Override
	public Element writeElement(SVGFEFuncAElement element, ElementFactory factory) {
