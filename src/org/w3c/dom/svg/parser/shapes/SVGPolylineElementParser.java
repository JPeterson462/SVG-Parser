...
public class SVGPolylineElementParser implements ElementParser<SVGPolylineElement> {
	...
	@Override
	public SVGPolylineElement readElement(Element element, ParsingState parsingState) {
		// Read and validate
	...
	@Override
	public Element writeElement(SVGPolylineElement element, ElementFactory factory) {
		...
		return factory.createElement(Tags.POLYLINE, attributes);
	}
