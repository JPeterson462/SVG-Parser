...
import org.w3c.dom.svg.document.SVGGElement;
...
public class SVGGElementParser implements ElementParser<SVGGElement> {

	@Override
	public SVGGElement readElement(Element element, ParsingState parsingState) {
		// Get default values
	...
	@Override
	public Element writeElement(SVGGElement element, ElementFactory factory) {
		...
		return factory.createElement(Tags.G, attributes);
	}
