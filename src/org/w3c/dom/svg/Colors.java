...
private static HashMap<String, RGBColor> colors = new HashMap<>();
	...
	static {
		...
		color("lavendar", 230, 230, 250);
		color("lavendarblush", 255, 240, 245);
	...
	public static RGBColor getColor(String name) {
		return colors.get(name);
	}
	
	private static void color(String name, int red, int green, int blue) {
		RGBColor color = new RGBColorImplementation(red, green, blue);
